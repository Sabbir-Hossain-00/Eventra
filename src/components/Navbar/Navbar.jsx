...
export const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50  transition-all duration-300 shadow-sm py-3 ${isDark ? "bg-black text-white" : "bg-white text-black"}`}>
      <div className=" navbar container mx-auto px-3 md:px-6 lg:px-8 xl:px-20 text-black dark:text-white">
        <div className="navbar-start">
          <div className={`dropdown ${isDark? "bg-black":"bg-white"}`}>
            ...
            <ul tabIndex={0} className={`menu menu-sm dropdown-content  rounded-box z-10 mt-3 w-52 p-2 shadow ${isDark ? "bg-gray-800 text-white" :"bg-white text-black"}`}>
              {links}
            </ul>
          </div>
