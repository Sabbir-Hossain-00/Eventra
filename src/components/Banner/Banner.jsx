...
export const Banner = ()=>{
    return(
        <section className="py-20">
             <div className=" grid lg:grid-cols-2 grid-cols-1  py-10 md:py-40 xl:py-50 md:px-30 px-3  gap-6  border-2 border-white rounded-2xl bg-gradient-to-b from-gray-100 to-white">
             ...
             <div >
                <img  className="w-full rounded-2xl" src="https://i.ibb.co.com/0Rz3mjXS/mayne-3jy03i-Dh74-unsplash.jpg" alt="" />
             </div>
             </div>
        </section>
    )
